...
| [#8423](https://github.com/QwenLM/qwen-code/pull/8423) | 🟡 open | feat(serve): observe daemon and child memory against real denominators | [pr-8423.md](pr-8423.md) |
...
| [#8507](https://github.com/QwenLM/qwen-code/pull/8507) | 🟡 open | feat(external-context): Add optional Mem0 memory writes | [pr-8507.md](pr-8507.md) |
...
| [#8572](https://github.com/QwenLM/qwen-code/pull/8572) | 🟡 open | feat(daemon): Add SSE stream and client observability | [pr-8572.md](pr-8572.md) |
| [#8588](https://github.com/QwenLM/qwen-code/pull/8588) | 🟡 open draft | feat(serve): Expose active work state | [pr-8588.md](pr-8588.md) |
| [#8620](https://github.com/QwenLM/qwen-code/pull/8620) | 🟡 open | fix(serve): Allow approved same-host text reads outside workspace | [pr-8620.md](pr-8620.md) |
