# 2026-06-01_2026-06-07 PR 实现与方案记录

收录 @doudouOUC 个人 PR 的最终实现，以及 open/closed PR 的当前或历史方案观察。

| PR | 状态 | 标题 | 文档 |
|---|---|---|---|
| [#4661](https://github.com/QwenLM/qwen-code/pull/4661) | 已合入 | feat(telemetry): per-prompt traceId for bounded, renderable traces | [pr-4661.md](pr-4661.md) |
...
| [#4689](https://github.com/QwenLM/qwen-code/pull/4689) | 已合入 | fix(daemon): isolate parallel subAgent text streams in transcript reducer | [pr-4689.md](pr-4689.md) |
| [#4693](https://github.com/QwenLM/qwen-code/pull/4693) | 已合入 | feat(telemetry): enrich llm_request span with response metadata and error details | [pr-4693.md](pr-4693.md) |
| [#4694](https://github.com/QwenLM/qwen-code/pull/4694) | 已合入 | fix(daemon): compacted session replay for long-session recovery | [pr-4694.md](pr-4694.md) |
...
| [#4765](https://github.com/QwenLM/qwen-code/pull/4765) | 已合入 | fix(daemon): preserve parentToolCallId in compaction engine for parallel subagent streams | [pr-4765.md](pr-4765.md) |
| [#4774](https://github.com/QwenLM/qwen-code/pull/4774) | 已合入 | refactor(daemon): simplify code and strip PR/commit references from comments | [pr-4774.md](pr-4774.md) |
| [#4811](https://github.com/QwenLM/qwen-code/pull/4811) | 已合入 | feat(cli): enable /remember, /forget, /dream in ACP mode | [pr-4811.md](pr-4811.md) |
| [#4812](https://github.com/QwenLM/qwen-code/pull/4812) | 已合入 | feat(serve): add POST /session/:id/branch for session forking | [pr-4812.md](pr-4812.md) |
...
| [#4819](https://github.com/QwenLM/qwen-code/pull/4819) | 已合入 | feat(cli): enable /remember, /forget, /dream in ACP mode | [pr-4819.md](pr-4819.md) |
| [#4820](https://github.com/QwenLM/qwen-code/pull/4820) | 已合入 | feat(serve): add HTTP rewind endpoints for daemon/web-shell (issue #4514 T3.2) | [pr-4820.md](pr-4820.md) |
| [#4822](https://github.com/QwenLM/qwen-code/pull/4822) | 已合入 | feat(serve): add hooks diagnostic HTTP/ACP surface (issue #4514 T3.9) | [pr-4822.md](pr-4822.md) |
| [#4826](https://github.com/QwenLM/qwen-code/pull/4826) | 已合入 | feat(cli): enable /directory command in ACP mode | [pr-4826.md](pr-4826.md) |
