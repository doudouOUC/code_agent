...
> 说明：含 W22 漏收补录（#4658/#4661，创建于 05-31）。25 PR 中 22 个已审查完毕（首批 11 + 补充 12 - 1 closed）；#4812/#4816/#4832 于 06-08 合入，待审。
...
> 注：#4812（session forking）、#4816（/settings）、#4832（extensions diagnostic）于 06-08 合入，待补充审查；#4817（closed，superseded by #4820）不单独审查。
