...
**时间范围**: 2026-04-06 ~ 2026-07-06（持续更新）
**总计**: 239 PRs（按当前保留的 @doudouOUC 个人 PR 最终实现文档计）
**代码量**: W15–W22 历史累计 +361,436 / -61,427；W23/W24/W25/W27/W28 见对应周目录（W28 当前个人增量 +2,581 / -281，36 个文件变更）
...
| [2026-07-06 ~ 2026-07-12](2026-07-06_2026-07-12/) (W28 日增量) | 4 | 2/2/0 | +2,581/-281 | session start profiler、ACP `/tmp` local fallback read、daemon workspace runtime registry、大文本范围读取 |

## 类型分布

feat ×110, fix ×80, refactor ×12, other ×11, docs ×7, chore ×5, test ×2, perf ×2, merge ×1
