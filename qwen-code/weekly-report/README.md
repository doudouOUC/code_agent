...
**时间范围**: 2026-04-06 ~ 2026-07-07（持续更新）
**总计**: 243 PRs（按当前保留的 @doudouOUC 个人 PR 最终实现文档计）
**代码量**: W15–W22 历史累计 +361,436 / -61,427；W23/W24/W25/W27/W28 见对应周目录（W28 当前个人增量 +7,642 / -673，111 个文件变更）
...
| [2026-07-06 ~ 2026-07-12](2026-07-06_2026-07-12/) (W28 周内累计) | 8 | 7/1/0 | +7,642/-673 | session start profiler、ACP `/tmp` local fallback read、daemon workspace runtime registry、大文本范围读取、settings reload signal、PDF 读取预算、Phase 2a workspace foundation、serve env/total admission open 方案 |

## 类型分布

feat ×119, fix ×84, refactor ×12, other ×8, docs ×8, chore ×6, perf ×3, test ×2, merge ×1
