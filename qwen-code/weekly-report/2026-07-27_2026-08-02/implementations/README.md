...
仅保留 @doudouOUC 个人 PR 的实现文档。open / draft PR 只记录当前 diff 方案，不能视为 `main` 已落地能力。
...
| [#7877](https://github.com/QwenLM/qwen-code/pull/7877) | 🟡 open | feat(external-context): Add submitted-prompt auto recall | [pr-7877.md](pr-7877.md) |
...
| [#7947](https://github.com/QwenLM/qwen-code/pull/7947) | 🟡 draft | fix(serve): allow bounded reads of large text files | [pr-7947.md](pr-7947.md) |
