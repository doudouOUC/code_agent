...
这些端点没有 SSE delta；它们是 snapshot/export surface。`session_stats` 已经是能力标签，早期 README 把 `stats/export` 作为未落地整体描述已经过期：stats 已落地，primary export 由 #6297 落地，workspace-qualified export 由 #6844 落地。
