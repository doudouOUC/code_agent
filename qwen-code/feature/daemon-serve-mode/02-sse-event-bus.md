...
| [#8572](https://github.com/QwenLM/qwen-code/pull/8572) | W32 open | 为每条 REST SSE stream 增加 daemon 分配的 stream UUID、客户端 connect reason / previous stream lineage、EventBus subscriber diagnostics callback，以及 open/resync/slow-client/eviction/close telemetry。 |
