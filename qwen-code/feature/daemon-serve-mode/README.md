...
| #10643(open) | worktree-isolated named tasks | 当前 diff 用 `session_worktree_persistence_v1`、canonical relocate、排他 marker+原子 sidecar 和 strict restore attestation 建立 persisted-v1 worktree session；latest head 延后 AUQ/reconciliation，并在 post-spawn cleanup 不确定时保留 worktree；尚未合入。 |
...
| #10751(open) | session turn navigation protocol | 当前 Phase 1 diff 增加 sparse turn index、HMAC snapshot、snapshot-bound transcript anchor、ACP vendor method 与 TS SDK；浏览器 page table/virtualized rail 尚未实现。 |
...
| #10924(open) | mandatory Conversations writer fences | 当前 diff 为 Conversations ACP child 增加私有 marker/forwarding attestation、强制 lease、identity-qualified local reclaim、batch writer error 保留、generation-scoped directory pin 与 unbound-task eligibility；外层 global owner 仍保留。 |
...
8. **open/draft diff 不能写成 main 已落地能力**。#8093/#8824 为 closed draft，#9048/#10286/#10786 为 closed，只能作为历史前身记录。#10643/#10751/#10924 为 open，只能作为当前方案记录。#10828 已合入 docs-only design，但设计中的 runtime cutover 不能写成 main 已落地；#9513/#9626/#9665/#9687/#9738/#9763/#9819/#9820/#9838/#9933/#9976/#9978/#10142/#10144/#10179/#10268/#10269/#10294/#10300/#10403/#10418/#10514/#10554/#10569/#10576/#10653/#10706/#10719/#10824 已按 merged diff 更新；#8743 已由 #9055 runtime PR 承接，不再按未落地 draft 追踪。其余 merged PR 继续以最终 diff 为准。
