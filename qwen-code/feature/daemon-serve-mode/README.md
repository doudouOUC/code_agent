...
| 11 | [WebUI 库与 ACP 传输层](11-webui-and-transport.md) | @qwen-code/webui、context-usage API、ACP Streamable HTTP、WebSocket transport、trust hot reload applying/failed UI state、workspace-scoped Web Shell Voice（#7754）、live journal repair（#8414 merged）、ACP textual tool-result projection（#8450 merged）、WebUI SSE reconnect reason（#8572 merged）、restore request/watchdog timeout（#8691 merged）、same-id attachment stale-work fencing（#8833 merged）、shared session catalog scheduling（#8891 merged）、prompt-safe navigation（#8931 merged）、restore request shape fencing（#8933 merged）、transactional cross/same-session switching（#8882/#8939 merged）、prompt admission ownership hardening（#8955 merged）、same-session refresh race closeout（#8990 merged）、transactional resync/live-journal repair（#9048 closed observation）、selective restore runtime（#9055 merged）、Web Shell text file attachments（#9180 merged）、workspace session live-state handshake design（#9261 open draft）、internal Conversations runtime visibility guard（#9181 open）与 ACP HTTP pre-attach budget（#9007 merged） |
...
| #9134(open) | active-work close authorization | 当前 open follow-up 让 conditional close 在拒绝前不取消 queued work，deferred kill 避开 close/probe in-flight，并把 child definitive close refusal 处理为可重试保留。 |
...
| #9181(open) | Conversations runtime boundary isolation | 当前 open diff 增加 Conversations runtime owner record、serve lifecycle release proof、activity gate 和 ordinary runtime visibility guard，隐藏 internal `live-conversation` runtime。 |
...
| #9134(open) | active-work close authorization | 当前 open diff 修复 `onlyIfUnheld` close 的非破坏性授权、共享 drain deadline、deferred spawn-owner kill 顺序和 definitive close refusal 下的 sibling-safe 保留。 |
...
| #9181(open) | Conversations runtime boundary isolation | 当前 open diff 增加 Conversations runtime owner record、ServeAppLifecycle release proof、shutdown activity gate 和 ordinary workspace visibility guard。 |
...
8. **open/draft diff 不能写成 main 已落地能力**。#7967/#8245/#8383/#9134/#9181 为 open，#8093/#9261 为 open draft，#8824 为 closed draft，#9048 为 closed；这些只能作为当前方案或历史前身记录。#8743 已由 #9055 runtime PR 承接，不再按未落地 draft 追踪。#7812/#7821/#7886/#7894/#7947/#7975/#7976/#7994/#8002/#8080/#8387/#8414/#8415/#8423/#8450/#8462/#8464/#8469/#8508/#8572/#8588/#8620/#8691/#8833/#8852/#8882/#8890/#8891/#8892/#8893/#8911/#8931/#8932/#8933/#8939/#8947/#8954/#8955/#8990/#9007/#9042/#9055/#9180 已按 merged diff 更新。
