...
### W28 2026-07-06 ~ 2026-07-10 daemon / serve follow-up
...
| #6635 | channel worker workspace grouping（open） | selected channels 按 owning trusted workspace 分组，每个 workspace 一个 worker supervisor，status/pidfile 暴露 group snapshot。 |
...
| #6635 | channel worker grouping（open） | multi-workspace channel worker group 与 pidfile/status 扩展。 |
