...
| #10269(open) | model provider runtime sync | 当前 diff 在 provider mutation 后同步 parent env、active ACP child 与 live Session registry，并以 optional `runtimeSync` 报告结果。 |
| #10286(closed) / #10300(open) | post-commit session cleanup ownership | #10286 已关闭；#10300 基于 merged standalone lifecycle，以 exact writer lock ownership 保护 transcript commit 后的 sidecar cleanup。 |
| #10403(open) | trusted-loopback operator authority | 当前 diff 在实际 primary loopback、无 token、未启用 `--require-auth` 时授予完整 operator authority，统一 strict mutation、显式 session shell、Local Control pairing 与 Web Shell Channel controls。 |
...
8. **open/draft diff 不能写成 main 已落地能力**。#8093/#8824 为 closed draft，#9048/#10286 为 closed，只能作为历史前身记录。#9626/#9738/#10269/#10300/#10403/#10514 为 open，只能作为当前方案记录。#9513/#9665/#9687/#9763/#9819/#9820/#9838/#9933/#9976/#9978/#10142/#10144/#10179/#10268/#10294/#10418 已按 merged diff 更新；#8743 已由 #9055 runtime PR 承接，不再按未落地 draft 追踪。其余 merged PR 继续以最终 diff 为准。
