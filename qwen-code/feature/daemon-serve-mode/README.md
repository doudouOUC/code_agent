...
8. **open/draft diff 不能写成 main 已落地能力**。#8093/#8824 为 closed draft，#9048 为 closed，只能作为历史前身记录。#9626/#9738/#9838 为 open，只能作为当前方案记录。#9513/#9665/#9687/#9763/#9819/#9820/#9933 已按 merged diff 更新；#8743 已由 #9055 runtime PR 承接，不再按未落地 draft 追踪。其余 merged PR 继续以最终 diff 为准。
