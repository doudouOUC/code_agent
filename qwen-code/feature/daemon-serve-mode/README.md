...
| #9838(open) | current-session scheduled task | 当前 diff 用 Core prompt context、private ACP identity、Serve owner/lifecycle admission、generation rollback 与条件 capability 允许 durable task 显式复用当前普通 session。 |
...
| #9978(open) | standalone session PR2B internal core | 当前 diff 增加 fail-closed `StandaloneSessionService`、私有目录 containment、owner routing 与 source-aware guards；不开放 public route/capability/SDK/UI。 |
...
8. **open/draft diff 不能写成 main 已落地能力**。#8093/#8824 为 closed draft，#9048 为 closed，只能作为历史前身记录。#9626/#9738/#9838/#9978 为 open，只能作为当前方案记录。#9513/#9665/#9687/#9763/#9819/#9820/#9933/#9976 已按 merged diff 更新；#8743 已由 #9055 runtime PR 承接，不再按未落地 draft 追踪。其余 merged PR 继续以最终 diff 为准。
