...
- **资源预算 foundation 先独立落地（#8093 open draft，#8245/#8423 merged，#8462/#8508 merged）**：#8093 当前 draft 只提供 `ResourceBudget`、fair schedulers 与 buffered process runner primitives，不接生产路由、不广告 capability，也不改变 daemon 行为；#8245/#8423 只补 status denominator/pressure observation；#8462 已把 active ACP child RSS aggregate 接入 status 观测；#8508 已发布 observe-only child heap partition model，但不应用 per-child ceiling、不拒绝 spawn、不提供 enforce 模式。
...
| #7967(open) | handle-bound text range reader | 当前 open diff 将 path reader 与 caller-owned handle reader 分离，删除混合 flag/dead fields，为 cursor paging 复用同一 descriptor 铺路。 |
...
| #9261(open draft) | workspace session live-state protocol | docs-only 设计，规划 selected-runtime/trusted-only `/workspaces/:workspace/sessions/live-state`、catalog version token、cache invalidation 顺序和 Web Shell/SDK refresh handshake；尚未实现生产路由。 |
...
| #9362(open) | transient runtime record I/O retryability | 当前 open diff 修复 Conversations owner/discovery record 的 transient `open`/`readFile` 错误分类，普通 EMFILE/EIO 继续走 retryable runtime unavailable，ELOOP/malformed/unsafe state 才 permanent compromised。 |
...
| #9261(open draft) | workspace session live-state protocol | docs-only 设计，规划纯内存 live-state 探针、daemon-local catalog version、cache invalidation 和客户端双读握手；尚未实现路由或 Web Shell 轮询。 |
...
| #9362(open) | runtime record I/O retryability | 当前 open diff 让 Conversations runtime owner/discovery record 的 transient open/read failures 保持 retryable，避免一次 I/O 故障永久 compromised。 |
...
8. **open/draft diff 不能写成 main 已落地能力**。#7967/#8245/#8383 为 open，#8093/#9261 为 open draft，#8824 为 closed draft，#9048 为 closed；这些只能作为当前方案或历史前身记录。#8743 已由 #9055 runtime PR 承接，不再按未落地 draft 追踪。#7812/#7821/#7886/#7894/#7947/#7975/#7976/#7994/#8002/#8080/#8387/#8414/#8415/#8423/#8450/#8462/#8464/#8469/#8508/#8572/#8588/#8620/#8691/#8833/#8852/#8882/#8890/#8891/#8892/#8893/#8911/#8931/#8932/#8933/#8939/#8947/#8954/#8955/#8990/#9007/#9042/#9055/#9134/#9180/#9181 已按 merged diff 更新。
