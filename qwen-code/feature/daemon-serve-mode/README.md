...
| 07 | [acp-bridge 抽包与多客户端权限协调](07-acp-bridge-and-permission.md) | 抽包 seam、四策略权限仲裁、并发不变量、same-host read/write delegation 能力分离（#8620 merged）、approved external built-in text writes provenance/host route（#8852 merged）、repeated tool execution failure guard（#8469 merged）、daemon ACP/HTTP resource guard（#8911/#8947/#9007 merged）、ACP channel liveness（#9976 merged）、process-tree ownership（#10142 open）、standalone private service/guard（#9978 merged；#10179 open public API）、active-work close refusal/hold 上限（#9134/#9820 merged）、private current-session task creator/empty persistence（#9838/#10144 merged）、permission/AUQ timeout 默认 disabled（#9933 merged）与 load/resume AUQ restore/hardening（#9665/#9763 merged） |
...
| #10142(open) | ACP process-tree reaping | 当前 diff 给标准 ACP spawn 增加 tree ownership、bounded process snapshot、TERM→KILL 与 root-exit cleanup；legacy attach 保持 direct-child。 |
...
| #10179(open) | standalone public daemon API | 当前 diff 条件广告 `standalone_sessions_v1`，增加 `/standalone/sessions` route family、exact owner admission 与 journaled delete recovery。 |
...
8. **open/draft diff 不能写成 main 已落地能力**。#8093/#8824 为 closed draft，#9048 为 closed，只能作为历史前身记录。#9626/#9738/#10142/#10179 为 open，只能作为当前方案记录。#9513/#9665/#9687/#9763/#9819/#9820/#9838/#9933/#9976/#9978/#10144 已按 merged diff 更新；#8743 已由 #9055 runtime PR 承接，不再按未落地 draft 追踪。其余 merged PR 继续以最终 diff 为准。
