...
### W33 2026-08-10 ~ 2026-08-15 daemon / serve follow-up
...
| #9007(open) | ACP HTTP pre-attach byte budgets | 当前 open diff 给 pre-attach buffered JSON-RPC reply 增加 serialized-byte budget 和 delivery receipt，超限时关闭精确 logical connection。 |
...
| #9134(open) | active-work close authorization | 当前 open follow-up 让 conditional close 在拒绝前不取消 queued work，并在最后 attacher detach 后优先完成 deferred spawn-owner kill。 |
| #9180(open) | Web Shell text file attachments | 当前 open diff 让 composer paste/drop 接收文本文件，渲染 file chips，并把内容作为 ACP `resource` blocks 随 prompt 投递。 |
...
| #9134(open) | active-work close authorization | 当前 open diff 修复 `onlyIfUnheld` close 的非破坏性授权、共享 drain deadline 与 deferred spawn-owner kill 顺序。 |
| #9180(open) | Web Shell text file attachments | 当前 open diff 支持 paste/drop 文本文件、composer file chip、queue/retry/restore 生命周期和 daemon prompt `resource` block 投递。 |
...
8. **open/draft diff 不能写成 main 已落地能力**。#7967/#8245/#8383/#9007/#9134/#9180/#9181 为 open，#8093 为 open draft，#8824 为 closed draft，#9048 为 closed；这些只能作为当前方案或历史前身记录。#8743 已由 #9055 runtime PR 承接，不再按未落地 draft 追踪。#7812/#7821/#7886/#7894/#7947/#7975/#7976/#7994/#8002/#8080/#8387/#8414/#8415/#8423/#8450/#8462/#8464/#8469/#8508/#8572/#8588/#8620/#8691/#8833/#8852/#8882/#8890/#8891/#8892/#8893/#8911/#8931/#8932/#8933/#8939/#8947/#8954/#8955/#8990/#9042/#9055 已按 merged diff 更新。
