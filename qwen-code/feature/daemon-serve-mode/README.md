...
### W33 2026-08-10 ~ 2026-08-11 daemon / serve follow-up
...
| #8890(open draft) | standalone daemon sessions design | docs-only draft 设计 daemon-managed standalone session、私有 work dir、context kind、create/delete/restore 与兼容策略；当前不改运行时代码。 |
...
| #8933(open) | restore request shape fencing | 当前 open diff 按 target + resume/load/all/recent(N) 区分 restore coalescing，避免不同 replay 语义互相满足。 |
| #8939(open draft) | transactional same-session refresh | 当前 draft open diff 让 same logical session load/reload/resume/clientId rebind 先 staging candidate，commit 前保留 source attachment/transcript/event stream。 |
| #8947(open) | ACP transport resource guard | 当前 open diff 在 #8911 raw stream bounds 之外，限制 ACP handler/prepared response/outbound/outstanding request 队列并让 fatal failure 立即隔离 channel generation。 |
...
8. **open/draft diff 不能写成 main 已落地能力**。#7967/#8093/#8245/#8383/#8882/#8933/#8947 仍为 open，#8743/#8890/#8939 仍为 draft open，#8824 为 closed draft；这些只能作为当前方案或历史前身记录。#7812/#7821/#7886/#7894/#7947/#7975/#7976/#7994/#8002/#8080/#8387/#8414/#8415/#8423/#8450/#8462/#8464/#8469/#8508/#8572/#8588/#8620/#8691/#8833/#8852/#8891/#8892/#8893/#8911/#8931/#8932 已按 merged diff 更新。
