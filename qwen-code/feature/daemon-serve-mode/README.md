...
### W33 2026-08-10 ~ 2026-08-14 daemon / serve follow-up
...
| #9134(open draft) | active-work close authorization | 当前 draft open follow-up 让 conditional close 在拒绝前不取消 queued work，并在最后 attacher detach 后优先完成 deferred spawn-owner kill。 |
...
| #9134(open draft) | active-work close authorization | 当前 draft open 修复 `onlyIfUnheld` close 的非破坏性授权、共享 drain deadline 与 deferred spawn-owner kill 顺序。 |
