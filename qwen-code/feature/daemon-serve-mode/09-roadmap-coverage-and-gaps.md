...
2026-08-24 的最新增量继续收敛 restore/WebUI 一致性、activeWork、Conversations runtime boundary、persisted maintenance、live-state、daemon resource guard 与工具调用安全边界：#8691/#9055 已合入 restore timeout 与 selective restore；#8833/#8882/#8933/#8939/#8955/#8990 已补 attachment/switching/restore shape/prompt ownership，#9048 closed diff 只作 resync/repair 未合入观察。#8588/#9042/#9134 已合入 activeWork lifecycle、shell hold 与 non-destructive close authorization。#9261/#9366/#9396/#9476/#9563 已合入 live-state route/consumer/activity/title guard。#9435/#9436 已合入 duplicate provider tool-call id 的可见 loop stop 与 argument-aware replay。#8890/#9181/#9362/#9341/#9512 已合入 Conversations runtime boundary、retryability 与 standalone primitives；#9513/#9665/#9687/#9763 又合入 archive race recovery、default-off AUQ restore/hardening 与 per-session model restore。#9626 当前 open diff 只处理 persisted maintenance/conflict repair，#9738 当前 open runtime diff 新增 `serve --open-with-auth`；两者不能视为 main 已落地能力。#8824 为 closed draft 前身；durable checkpoint follow-up 仍是独立路线图项。

2026-08-31 follow-up：#9838/#9978/#10142/#10144/#10179/#10268/#10294/#10300/#10403/#10418 已合入 current-session scheduled task、standalone internal/public lifecycle、empty-session persistence、ACP process-tree ownership、new-session deadline、standalone SDK、post-commit writer-owned cleanup、trusted-loopback authority 与显式 WebUI product context；#10286 已关闭并由 #10300 取代。#10514(open) 已从 UI 计划推进为 standalone WebShell runtime diff，覆盖入口、Recents、深链、项目功能隔离与 typed recovery；#10554(open) 是 sessionless 用户语言同步 diff。两者仍不能视为 `main` 能力，跨 runtime move/fork、standalone durable scheduling 和逃逸进程组回收仍是后续范围。
