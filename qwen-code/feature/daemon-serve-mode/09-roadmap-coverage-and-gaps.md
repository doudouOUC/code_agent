...
2026-08-28 follow-up：#9838/#9978/#10142/#10144/#10179 已合入 current-session scheduled task、standalone internal/public lifecycle、empty-session persistence 与 ACP process-tree ownership；#10268 当前 open diff 补 new-session deadline/late cleanup，#10286 已关闭并由 #10300(open) 接续 post-commit writer-owned cleanup，#10294 已合入 standalone TypeScript SDK。open diff 仍不能视为 `main` 能力，且 public UI、跨 runtime move/fork 和逃逸进程组回收仍是后续范围。
