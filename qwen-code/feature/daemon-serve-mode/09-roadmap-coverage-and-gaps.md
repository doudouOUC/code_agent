...
2026-08-27 follow-up：#9838/#9978/#10144 已合入 current-session scheduled task、standalone internal core 与 empty-session persistence；#10142 当前 open diff 补 ACP process-tree ownership，#10179 当前 open diff 在 internal core 上增加条件 `standalone_sessions_v1`、public route family 和 journaled delete。后两者仍不能视为 `main` 能力，且 public SDK/UI、跨 runtime move/fork 和逃逸进程组回收仍是后续范围。
