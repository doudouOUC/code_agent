...
2026-08-30 follow-up：#9838/#9978/#10142/#10144/#10179/#10268/#10294/#10418 已合入 current-session scheduled task、standalone internal/public lifecycle、empty-session persistence、ACP process-tree ownership、new-session deadline、standalone SDK 与显式 WebUI product context；#10286 已关闭并由 #10300(open) 接续 post-commit writer-owned cleanup，#10514(open) 仅是 standalone WebShell PR6 UI 计划。open diff/计划仍不能视为 `main` 能力，且可见 UI、跨 runtime move/fork 和逃逸进程组回收仍是后续范围。
