...
2026-08-21 的最新增量继续收敛 restore/WebUI 一致性、activeWork、Conversations runtime boundary、persisted storage、live-state、daemon resource guard 与工具调用安全边界：#8691 已合入大型 session restore timeout/late cleanup/quarantine；#9055 已把 #8743 selective restore 推进为 runtime 实现。#8833/#8882/#8933/#8939/#8955/#8990 已补 same-id attachment、cross/same-session switching、restore shape 与 prompt ownership；#9048 closed diff 只作为 resync/repair 未合入观察。#8588/#9042/#9134 已合入 activeWork lifecycle、background shell hold 与 non-destructive close authorization。#8891/#8931 已合入 WebShell shared catalog/prompt-safe navigation；#9180 已合入 text file attachments；#9261/#9366/#9396/#9476 已合入 workspace live-state route、WebShell consumer、activity watermark 与 completion consumer，#9563 又阻止 effective title 已解析后重复 catalog refresh。#8911/#8947/#9007 已合入 ACP resource guards；#9380 已合入 observe-only child heap measurement；#9435/#9436 已合入 duplicate provider tool-call id 的可见 loop stop 与 argument-aware replay。#8890/#9181/#9362 已合入 Conversations runtime foundation/boundary 与 transient record I/O retry；#9341/#9512 已合入 standalone source/identity primitives 及 hardening。#9513 仍是五项 PR2A load/resume/metadata 回归修复 open diff，#9626 是完整 persisted storage lifecycle/conflict repair open draft，#9665 是默认关闭的 AUQ restore open diff，均不能视为 main 已落地能力。#8824 为 closed draft 前身；durable checkpoint follow-up 仍是独立路线图项。
