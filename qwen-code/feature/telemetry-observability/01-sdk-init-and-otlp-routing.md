...
| [#7447](https://github.com/QwenLM/qwen-code/pull/7447) | CLOSED `2026-07-21` | perf(telemetry): Lazy-load the SDK and split OTLP exporter chains by protocol | 与 #7276 同目标的早期 diff；未合入，最终实现由 #7276/#7456 承接。 |
