...
> 当前记录：#6404 大文本范围读取、#6409 大型 PDF 文本提取预算，均已按 merged diff 复核。
...
#6404 解决“大文本应该能按范围有界读取”；#6409 解决“大 PDF 全文 fallback 不应进入上下文，但显式页码读取仍应可用”。
...
- PDF page extraction 仍依赖本机 `pdftotext`；缺失 poppler 时 direct read 会提示安装依赖。
