...
#12477 and #12478 have merged the two correctness gates required before server wiring and multi-broker dispatch. Process reconciliation, authoritative `UNKNOWN` resolution, schema migration deployment, concrete service/transport wiring, and multi-process end-to-end validation remain follow-up work.
