...
| C18 默认切换/回退         | [实施计划](managed-agent-daemon-default-plan.md)、[客户端](managed-agent-client-surfaces.md)：按purpose/config/profile证据扩大，新建开关不改变已有owner | R4/R5；U01/U06/O07                |
