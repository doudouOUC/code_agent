...
| A2: contract gate | Language-neutral fixtures/schema, TS and Java consumers, required CI | Merged #12447 provides the shared files, TypeScript behavior tests, and Java fixture consumer; the Java client merged in #12522; required cross-language CI and durable READY reconcile/CAS remain outstanding |
