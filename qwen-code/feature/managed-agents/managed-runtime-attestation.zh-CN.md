...
| A2：契约门禁 | 语言无关 fixtures/schema、TS/Java 消费、required CI | 已合入的 #12447 提供共享文件、TypeScript 行为测试与 Java fixture consumer；Java attestation client 已由 #12522 合入；required 跨语言 CI lane 与持久 READY reconcile/CAS 仍未完成 |
