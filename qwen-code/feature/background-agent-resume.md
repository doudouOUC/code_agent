...
> 涉及 PR：#3739（背景 agent resume/continuation）、#4222（daemon session load/resume）、#5030（SDK / stream-json interrupted turn continuation without synthetic continue）、#5556（completed background sub-agent revive + transcript TTL）、#5679（agent/workflow integer env strict parse）
