...
2. daemon-managed worker 已支持 restart/heartbeat、prompt turn barrier、session listing、settings reload 和 workspace grouping；多进程 rolling upgrade、跨 daemon worker 迁移仍未在本页覆盖。
