...
| 主题 | 文档 | 关键 PR | 一句话 |
|---|---|---|---|
| daemon/serve 模式 | [daemon-serve-mode/](daemon-serve-mode/) | epic #4175 / #5977 / #5989 / #5995 / #6013 / #6031 / #6058 / #6098 / #6146 / #6253 / #6263 / #6270 / #6296 / #6297 / #6305 / #6309 / #6310 / #6314 / #6325 / #6335 | Mode B：agent core 常驻 HTTP daemon，多客户端经 REST+SSE 并发附着，ACP bridge 解耦；近期补 standalone serve fast path、daemon-managed channel worker、session archive、worker hardening、stderr credential redaction、dashboard、NDJSON perf、status activity、preflight auth、session export、session organization、batch load replay、settings cache、EventBus byte cap、prompt queue status 和 large pipe frame measurement。 |
...
| 诊断 / creator skills | [diagnostic-skills.md](diagnostic-skills.md) | #3404 #4133 #3079 #6117 #6233 | `/doctor` 代码命令、`/stuck` 诊断技能、`/batch` prompt 技能、ACP/non-interactive `/skills` 列表输出和 disabled skill 状态过滤。 |
