...
| Channel adapters | [channel-adapters.md](channel-adapters.md) | #5978 / #6031 / #6098 / #6165 / #6182 / #6309 / #6598 / #6635 / #6741 / #6950 / #7019(open) | `ChannelAgentBridge` adapter-facing 合约，把 channel adapter 从具体 `AcpBridge` 实现中解耦；daemon-managed channel worker 由 `qwen serve --channel` 托管，并补 prompt turn barrier、session listing、batch load replay、settings reload、multi-workspace worker grouping、runtime daemon channel control、startup failure diagnostics 和 ownership hardening 文档口径。 |
