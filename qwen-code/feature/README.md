...
| CLI 启动性能 | [cli-startup-performance.md](cli-startup-performance.md) | #3318 #3319 #3297 #3232 #6349(open) | API 预连接、早期输入捕获、工具懒注册、启动 profiler；#6349 记录 session-start profiler open 方案。 |
...
| 文件读取 / 大文本范围 | [file-reading.md](file-reading.md) | #6404(open) | 大文本范围读取 open 方案：超过旧 10MB 文本 guard 时返回有界行范围，非文本大小保护不变。 |
...
_生成于 2026-05-31；按个人 PR 口径更新于 2026-07-07_
