...
| CUA driver / computer-use | [cua-driver.md](cua-driver.md) | #5896 | vendored `qwen-cua-driver` + opt-in 0-1000 relative-coordinate shim，打通 Qwen-VL `computer_use` 与 pixel-based CUA driver |
...
> 逐 PR 明细见 [recent-pr-feature-coverage.md](recent-pr-feature-coverage.md)。覆盖口径：`created:2026-06-22..2026-06-26` 全作者、全状态 PR；统计以 2026-06-27 查询为准，共 212 个 PR：162 merged / 27 open / 23 closed。2026-06-26 创建 20 个 PR（13 merged / 7 open），当天合入 18 个 PR；06-25~26 合入但创建更早的 #5561 也按本周落地能力纳入。
...
| [daemon-serve-mode/](daemon-serve-mode/) | #5613 #5638 #5741 #5743 #5752 #5753 #5755 #5765 #5784 #5785 #5797 #5825 #5857 #5874 #5892 #5906 | 补 Web Shell branch/fork、workspace defaults、permissions/LSP/status/voice/control APIs、startup fast path、benchmark、single-session status route、Windows PTY tree-kill、settings minimum validation。 |
| [daemon-serve-mode/11-webui-and-transport.md](daemon-serve-mode/11-webui-and-transport.md) | #5650 #5818 #5822 #5864 #5876 #5893 #5900 | 补 enhanced Markdown tables、active prompt loading、streaming turn command queue、thinking duration、中文工具组文案、Web Shell chat polish 与 host loading phrase customization。 |
...
| [cua-driver.md](cua-driver.md) | #5896 | 新增专题，覆盖 vendored `qwen-cua-driver`、相对坐标开关、输入 denormalization、工具契约改写、release/sync 边界。 |
...
_生成于 2026-05-31；最后更新 2026-06-27_
