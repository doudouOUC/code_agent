...
| CLI 启动性能 | [cli-startup-performance.md](cli-startup-performance.md) | #3318 #3319 #3297 #3232 #6349 #7145 #7182 | API 预连接、早期输入捕获、工具懒注册、启动 profiler；#6349 补 `GeminiClient.startChat()` session-start profiler；#7145/#7182 补 ACP initialize profile 与 ACP startup static closure 瘦身。 |
