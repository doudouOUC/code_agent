...
| 主题 | 文档 | 关键 PR | 一句话 |
|---|---|---|---|
| daemon/serve 模式 | [daemon-serve-mode/](daemon-serve-mode/) | epic #4175 / #3803 / #5977 / #5989 / #5995 / #6013 / #6031 / #6058 / #6098 / #6146 | Mode B：agent core 常驻 HTTP daemon，多客户端经 REST+SSE 并发附着，ACP bridge 解耦；近期补 standalone serve fast path、daemon-managed channel worker、session archive、worker hardening 和 stderr credential redaction。 |
...
| 诊断 / creator skills | [diagnostic-skills.md](diagnostic-skills.md) | #3404 #4133 #3079 #6117 | `/doctor` 代码命令、`/stuck` 诊断技能、`/batch` prompt 技能、ACP/non-interactive `/skills` 列表输出。 |
...
_生成于 2026-05-31；按个人 PR 口径更新于 2026-07-03_
