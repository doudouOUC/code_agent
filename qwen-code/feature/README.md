...
| 主题 | 文档 | 关键 PR | 一句话 |
|---|---|---|---|
| daemon/serve 模式 | [daemon-serve-mode/](daemon-serve-mode/) | epic #4175 / #3803 / #5977 / #5989 / #5995 / #6013 / #6031 / #6058 / #6098 | Mode B：agent core 常驻 HTTP daemon，多客户端经 REST+SSE 并发附着，ACP bridge 解耦；近期补 standalone serve fast path、daemon-managed channel worker、session archive 和 worker hardening。 |
...
| Channel adapters | [channel-adapters.md](channel-adapters.md) | #5978 / #6031 / #6098 | `ChannelAgentBridge` adapter-facing 合约，把 channel adapter 从具体 `AcpBridge` 实现中解耦；daemon-managed channel worker 由 `qwen serve --channel` 托管并补重启、心跳、日志脱敏。 |
...
| 权限系统 | [permission-system.md](permission-system.md) | #3467 #3726 #4335 #5085 #5105 #5218 #5258 #5260 #5743 #6026 #6087 | 规则解析与畸形规则守卫、多客户端权限协调、ACP 取消停止语义、workspace permissions API、subagent approval-mode override、subagent plan lifecycle tool 阻断。 |
...
_生成于 2026-05-31；按个人 PR 口径更新于 2026-07-02_
