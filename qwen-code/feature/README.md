...
| 主题 | 文档 | 关键 PR | 一句话 |
|---|---|---|---|
| daemon/serve 模式 | [daemon-serve-mode/](daemon-serve-mode/) | epic #4175 / #5977 / #5989 / #5995 / #6013 / #6031 / #6058 / #6098 / #6146 / #6253(closed) / #6263 / #6270 / #6292 / #6296 / #6297 / #6305 / #6309 / #6310 / #6314 / #6325 / #6335 / #6370 / #6394 / #6407 / #6410 / #6416 / #6482 / #6511 / #6525 / #6540 / #6558 / #6567 / #6598 / #6621 / #6625 / #6631 / #6635(open) / #6638(open) | Mode B：agent core 常驻 HTTP daemon，多客户端经 REST+SSE 并发附着，ACP bridge 解耦；近期补 standalone serve fast path、daemon-managed channel worker、session archive、worker hardening、stderr credential redaction、NDJSON perf、status activity、ACP session settings isolation、preflight auth、session export、session organization、batch load replay、settings cache、EventBus byte cap、prompt queue status、large pipe frame measurement、ACP `/tmp` local fallback、Phase 1/2a/2b/3/4 workspace runtime registry、settings reload signal、runtime env/total admission、bounded/paged transcript、multi-workspace live routing、secondary persisted/archived/organized session list、workspace-qualified REST/ACP、dynamic workspace registration、channel worker reload/grouping 与 extension management v2 open 方案。 |
...
| Channel adapters | [channel-adapters.md](channel-adapters.md) | #5978 / #6031 / #6098 / #6165 / #6182 / #6309 / #6598 / #6635(open) | `ChannelAgentBridge` adapter-facing 合约，把 channel adapter 从具体 `AcpBridge` 实现中解耦；daemon-managed channel worker 由 `qwen serve --channel` 托管，并补 prompt turn barrier、session listing、batch load replay、settings reload 和 multi-workspace worker grouping open 方案。 |
...
_生成于 2026-05-31；按个人 PR 口径更新于 2026-07-11_
