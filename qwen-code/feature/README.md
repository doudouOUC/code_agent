...
| auth/provider | [auth-providers.md](auth-providers.md) | #3212 #3495 #3623 #3624 #4255 #4291 #4305 #5179 #5404 #5478 #5539 #5553 #5632 #5637 #5638 #5654 #5729 #5769 #5778 #5793 #5827 #5835 #5845 #5946 | provider 配置/apiKey 保留/auth status 识别 + daemon 设备流(PKCE) + Requesty/custom provider + bare fast-model auth scope + workspace provider defaults + providerProtocol + OpenAI stream idle timeout/env knob + vision fallback model + provider install model preservation + Anthropic SDK abort listener isolation |
...
| 权限系统 | [permission-system.md](permission-system.md) | #3467 #3726 #4335 #5085 #5105 #5196 #5218 #5258 #5260 #5409 #5622 #5743 #5754 | 规则解析+畸形规则守卫 + 多客户端权限协调 + ACP 取消停止语义 + broad shell self-kill guard + workspace permissions API + auto 模式破坏性命令硬拦截 |
